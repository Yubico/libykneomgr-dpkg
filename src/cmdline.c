...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->applet_delete_given)
    write_into_file(outfile, "applet-delete", args_info->applet_delete_orig, 0);
  if (args_info->applet_install_given)
    write_into_file(outfile, "applet-install", args_info->applet_install_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->send_apdu_given, args_info->send_apdu_min, args_info->send_apdu_max, "'--send-apdu' ('-S')"))
     error = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'w':	/* Output firmware version for YubiKey NEO.  */
          ...
          if (update_arg((void *)&(args_info->get_version_flag), 0, &(args_info->get_version_given),
        ...
        case 's':	/* Output serial number.  */
          ...
          if (update_arg((void *)&(args_info->get_serialno_flag), 0, &(args_info->get_serialno_given),
        ...
        case 'l':	/* List all connected PCSC devices.  */
          ...
          if (update_arg((void *)&(args_info->list_readers_flag), 0, &(args_info->list_readers_given),
        ...
        case 'a':	/* List applets on device.  */
          ...
          if (update_arg((void *)&(args_info->applet_list_flag), 0, &(args_info->applet_list_given),
        ...
        case 'D':	/* Delete given applet AID from device.  */
          ...
          if (update_arg( (void *)&(args_info->applet_delete_arg), 
               &(args_info->applet_delete_orig), &(args_info->applet_delete_given),
              &(local_args_info.applet_delete_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "applet-delete", 'D',
              additional_error))
            goto failure;
        ...
        case 'i':	/* Install applets on device from CAP file.  */
          ...
          if (update_arg( (void *)&(args_info->applet_install_arg), 
               &(args_info->applet_install_orig), &(args_info->applet_install_given),
              &(local_args_info.applet_install_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "applet-install", 'i',
              additional_error))
            goto failure;
  ...
  update_multiple_arg((void *)&(args_info->send_apdu_arg),
    &(args_info->send_apdu_orig), args_info->send_apdu_given,
    local_args_info.send_apdu_given, 0,
    ARG_STRING, send_apdu_list);
